...
// *********************************************************
//
// File autogenerated for the tello_driver_wifi2 package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __tello_driver_wifi2__TELLOCONFIG_H__
#define __tello_driver_wifi2__TELLOCONFIG_H__
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TelloConfig::AbstractParamDescriptionConstPtr(new TelloConfig::ParamDescription<int>("fixed_video_rate", "int", 0, "Video rate", "{'enum_description': 'Video rate options', 'enum': [{'srcline': 9, 'description': 'Let drone automatically decide', 'srcfile': '/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Auto'}, {'srcline': 10, 'description': 'Set to 1.0Mb/s fixed rate (~4.5KB/frame @ 30fps)', 'srcfile': '/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': '1p0Mbps'}, {'srcline': 11, 'description': 'Set to 1.5Mb/s fixed rate (~6.6KB/frame @ 30fps)', 'srcfile': '/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': '1p5Mbps'}, {'srcline': 12, 'description': 'Set to 2.0Mb/s fixed rate (~8.5KB/frame @ 30fps)', 'srcfile': '/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': '2p0Mbps'}, {'srcline': 13, 'description': 'Set to 2.5Mb/s fixed rate ( ~11KB/frame @ 30fps)', 'srcfile': '/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': '2p5Mbps'}]}", &TelloConfig::fixed_video_rate)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg"
      const int Tello_Auto = 0;
//#line 10 "/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg"
      const int Tello_1p0Mbps = 1;
//#line 11 "/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg"
      const int Tello_1p5Mbps = 2;
//#line 12 "/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg"
      const int Tello_2p0Mbps = 3;
//#line 13 "/home/mech-user/semi_ws/src/tello_driver_wifi2/cfg/Tello.cfg"
