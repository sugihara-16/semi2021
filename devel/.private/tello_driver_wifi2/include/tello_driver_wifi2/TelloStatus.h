// Generated by gencpp from file tello_driver_wifi2/TelloStatus.msg
// DO NOT EDIT!


#ifndef TELLO_DRIVER_WIFI2_MESSAGE_TELLOSTATUS_H
#define TELLO_DRIVER_WIFI2_MESSAGE_TELLOSTATUS_H
...
struct TelloStatus_
{
  ...
  typedef boost::shared_ptr< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> const> ConstPtr;

}; // struct TelloStatus_

typedef ::tello_driver_wifi2::TelloStatus_<std::allocator<void> > TelloStatus;

typedef boost::shared_ptr< ::tello_driver_wifi2::TelloStatus > TelloStatusPtr;
typedef boost::shared_ptr< ::tello_driver_wifi2::TelloStatus const> TelloStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::tello_driver_wifi2::TelloStatus_<ContainerAllocator1> & lhs, const ::tello_driver_wifi2::TelloStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tello_driver_wifi2::TelloStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe6d1629583c9b3a3ULL;
  static const uint64_t static_value2 = 0x37a806afc71e19f7ULL;
};

template<class ContainerAllocator>
struct DataType< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::tello_driver_wifi2::TelloStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tello_driver_wifi2::TelloStatus_<ContainerAllocator>& v)
  {
    s << indent << "height_m: ";
...
#endif // TELLO_DRIVER_WIFI2_MESSAGE_TELLOSTATUS_H
